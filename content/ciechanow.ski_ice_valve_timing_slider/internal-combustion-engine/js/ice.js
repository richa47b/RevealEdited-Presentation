...
;(function () {
  ...
  let cam_f = function (a) {
    ...
    let nt = 1 - t
    let p =
      0.01 * 5 * nt * nt * nt * nt * t +
      0.16 * 10 * nt * nt * nt * t * t +
      0.12 * 10 * nt * nt * t * t * t +
      5 * nt * t * t * t * t +
      t * t * t * t * t
  ...
  let pressure_f = function (a) {
    ...
    return (
      ...
      0.2 * Math.pow(Math.cos(a - 0.2) * 0.5 + 0.5, 7) +
  ...
  function GLDrawer(scale, ready_callback) {
    ...
    download_file(
      '/ciechanow.ski_ice_valve_timing_slider/internal-combustion-engine/models/ice_vertices.dat',
      function (buffer) {
    ...
    download_file(
      '/ciechanow.ski_ice_valve_timing_slider/internal-combustion-engine/models/ice_indices.dat',
      function (buffer) {
...
`
    ...
    let complex_flame_shader = new Shader(
      gl,
    ...
    let line_ring_shader = new Shader(
      gl,
      line_ring_vert_src,
      line_frag_src,
      ['v_position', 'v_normal'],
    ...
    gl.vertexAttribPointer(
      cross_shader.attributes['v_position'],
      3,
      gl.FLOAT,
      false,
      24,
    ...
    gl.vertexAttribPointer(
      cross_shader.attributes['v_normal'],
      3,
      gl.FLOAT,
      false,
      24,
    ...
    gl.vertexAttribPointer(
      line_shader.attributes['v_position'],
      3,
      gl.FLOAT,
      false,
      24,
    ...
    gl.vertexAttribPointer(
      line_shader.attributes['v_normal'],
      3,
      gl.FLOAT,
      false,
      24,
    ...
    gl.vertexAttribPointer(
      ring_shader.attributes['v_position'],
      3,
      gl.FLOAT,
      false,
      24,
    ...
    gl.vertexAttribPointer(
      ring_shader.attributes['v_normal'],
      3,
      gl.FLOAT,
      false,
      24,
    ...
    gl.vertexAttribPointer(
      line_ring_shader.attributes['v_position'],
      3,
      gl.FLOAT,
      false,
      24,
    ...
    gl.vertexAttribPointer(
      line_ring_shader.attributes['v_normal'],
      3,
      gl.FLOAT,
      false,
      24,
    ...
    this.draw_points = function (mvp, t) {
      ...
      gl.vertexAttribPointer(
        point_shader.attributes['point_t'],
        1,
        gl.FLOAT,
        false,
        0,
    ...
    this.draw_spring = function (
      ...
      gl.vertexAttribPointer(
        spring_shader.attributes['v_position'],
        3,
        gl.FLOAT,
        false,
        24,
      ...
      gl.vertexAttribPointer(
        spring_shader.attributes['v_normal'],
        3,
        gl.FLOAT,
        false,
        24,
      ...
      gl.uniformMatrix4fv(
        spring_shader.uniforms['m_mvp'],
        false,
        mat4_transpose(mvp)
      )
      gl.uniformMatrix3fv(
        spring_shader.uniforms['m_rot'],
        false,
        mat3_invert(rotation)
      )
    ...
    this.draw_oil = function (mvp, rotation, color, opacity, half, t) {
      ...
      gl.vertexAttribPointer(
        oil_shader.attributes['v_position'],
        3,
        gl.FLOAT,
        false,
        24,
      ...
      gl.vertexAttribPointer(
        oil_shader.attributes['v_normal'],
        3,
        gl.FLOAT,
        false,
        24,
      ...
      gl.uniformMatrix4fv(
        oil_shader.uniforms['m_mvp'],
        false,
        mat4_transpose(mvp)
      )
      gl.uniformMatrix3fv(
        oil_shader.uniforms['m_rot'],
        false,
        mat3_invert(rotation)
      )
      ...
      gl.drawElements(
        gl.TRIANGLES,
        half ? cylinder_count / 2 : cylinder_count,
        gl.UNSIGNED_INT,
        cylinder_offset * 4
      )
    }
    ...
    this.draw_spiral = function (mvp, rotation) {
      ...
      gl.drawElements(
        ...
        gl.UNSIGNED_INT,
        mesh.line_index_offset * 4
      )
      vao_ext.bindVertexArrayOES(null)
    }

    this.draw_mesh = function (
      name,
      mvp,
      rotation,
      color,
      ...
      if (line_arg === undefined) line_arg = [2 / viewport_h, 0.01]

      line_arg.push(viewport_h / viewport_w)
      line_arg.push(backface ? -1 : 1)

      if (line_dim === undefined) line_dim = 0.6
    ...
    this.draw_ring_mesh = function (
      ...
      if (stretch == undefined) stretch = [0, 0]
      ...
      gl.uniformMatrix4fv(
        ring_shader.uniforms['m_mvp'],
        false,
        mat4_transpose(mvp)
      )
      gl.uniformMatrix3fv(
        ring_shader.uniforms['m_rot'],
        false,
        mat3_invert(rotation)
      )
      ...
      gl.uniformMatrix4fv(
        line_ring_shader.uniforms['m_mvp'],
        false,
        mat4_transpose(mvp)
      )
      gl.uniformMatrix3fv(
        line_ring_shader.uniforms['m_rot'],
        false,
        mat3_invert(rotation)
      )
  ...
  function Drawer(container, mode) {
    ...
    function tick(timestamp) {
      ...
      if (self.paused) prev_timestamp = undefined
    ...
    if (mode === 'crankshaft2') {
      ...
      rot = mat3_mul(
        rot_x_mat3(-0.7),
        mat3_mul(rot_z_mat3(0.8), rot_y_mat3(Math.PI))
      )
    ...
    let no_drag =
      mode === 'main_bearings_mount' ||
      mode === 'hydrodynamic' ||
      mode === 'crankshaft2' ||
      mode === 'piston_ring_fit' ||
      mode === 'piston_limits' ||
      mode === 'valve_seat' ||
      mode === 'valve_retainer' ||
      mode === 'cam_shape' ||
      ...
      mode === 'cam_belt2' ||
      mode === 'spark' ||
      mode === 'crankshaft_pressure' ||
      mode === 'crankshaft_torque' ||
      mode === 'pressure' ||
      mode === 'pressure_torque' ||
      mode === 'inertia_torque' ||
      mode === 'total_torque' ||
      mode === 'total4_torque' ||
    ...
    this.set_visible = function (x) {
      this.visible = x
      if (x && !this.was_drawn) request_repaint()
    }
    ...
    function rod_configuration(crank_angle) {
      ...
      let angle =
        -Math.PI +
        Math.acos(
          (d * d - rod_length * rod_length - crank_length * crank_length) /
            (-2 * rod_length * crank_length)
        )

      if (crank_angle < 0 && crank_angle > -Math.PI) angle = -angle
    ...
    this.repaint = function () {
      ...
      function draw_stroke_labels(a) {
        ...
        text =
          a < 1 ? 'intake' : a < 2 ? 'compression' : a < 3 ? 'power' : 'exhaust'
      ...
      function draw_bolt(r, l, tl, mvp, rot, color, opacity, washer) {
        ...
        if (l != 0)
          gl.draw_mesh(
            ...
            mat4_mul(
              mvp,
              mat4_mul(scale_mat4([r, r, l]), translation_mat4([0, 0, -1]))
            ),
            rot,
            color,
            opacity
        ...
        if (washer)
          gl.draw_mesh(
            ...
            mat4_mul(
              mvp,
              mat4_mul(
                scale_mat4([r * 1.5, r * 1.5, 3]),
                translation_mat4([0, 0, 0])
              )
            ),
            rot,
            color,
        ...
        gl.draw_mesh(
          ...
          mat4_mul(
            mvp,
            mat4_mul(
              translation_mat4([0, 0, washer ? 3 : 0]),
              scale_mat4([r * 1.4, r * 1.4, r * 1.2])
            )
          ),
          rot,
          color,
      ...
      function draw_crankshaft(
        ...
        if (
          ...
          web_color &&
          rod_color &&
          main_color == web_color &&
          web_color == rod_color
        )
          end_color = main_color

        if (!main_color) main_color = gray_color

        if (!rod_color) rod_color = gray_color

        if (!web_color) web_color = gray_color
        ...
        gl.draw_mesh(
          ...
          mat4_mul(
            mvp,
            translation_mat4([0, -main * 2.5 - 2 * rod - web * 4, 0])
          ),
          normal,
          end_color,
          opacity
        ...
        if (!skip_mains) {
          gl.draw_mesh(
            ...
            mat4_mul(
              mat4_mul(
                mvp,
                translation_mat4([0, -main * 1.5 - 2 * rod - web * 4, 0])
              ),
              mat4_mul(rot_x_mat4(Math.PI * 0.5), scale_mat4([31, 31, main]))
            ),
            mat3_mul(normal, rot_x_mat3(Math.PI * 0.5)),
            main_color,
            opacity
          )
          gl.draw_mesh(
            ...
            mat4_mul(
              mvp,
              translation_mat4([0, -main * 2 - 2 * rod - web * 4, 0])
            ),
            normal,
            main_color,
            opacity
        ...
        gl.draw_mesh(
          ...
          mat4_mul(
            mvp,
            mat4_mul(
              translation_mat4([0, -main * 1.5 - web * 4 - rod * 2, 0]),
              rot
            )
          ),
          rot_normal,
        ...
        if (!part)
          gl.draw_mesh(
            ...
            mat4_mul(
              mvp,
              mat4_mul(
                translation_mat4([0, -4 * web - 2 * main - 2 * rod, 0]),
                rot
              )
            ),
            rot_normal,
        ...
        gl.draw_mesh(
          ...
          mat4_mul(
            ...
            mat4_mul(
              mat4_mul(
                translation_mat4([0, (-main * 3) / 2 - rod - web * 2, 0]),
                rot
              ),
              y_flip_mat4
            )
        ...
        if (!skip_mains) {
          gl.draw_mesh(
            'Crankshaft_main_journal',
            mat4_mul(mvp, translation_mat4([0, -main - rod - web * 2, 0])),
            normal,
            main_color,
            opacity
          )
        ...
        gl.draw_mesh(
          ...
          mat4_mul(
            mvp,
            translation_mat4([0, -main * 0.5 - rod - web - web, 0])
          ),
          normal,
          web_color,
          opacity
        ...
        gl.draw_mesh(
          ...
          mat4_mul(
            mvp,
            mat4_mul(translation_mat4([0, -main / 2, 0]), y_flip_mat4)
          ),
          y_flip_normal,
          web_color,
          opacity,
        ...
        gl.draw_mesh(
          'Crankshaft_web',
          mat4_mul(mvp, translation_mat4([0, main / 2, 0])),
          normal,
          web_color,
          opacity
        )
        ...
        if (!part)
          gl.draw_mesh(
            'Crankshaft_rod_journal',
            mat4_mul(mvp, translation_mat4([0, 0, 0])),
            normal,
            rod_color,
            opacity
          )
        ...
        gl.draw_mesh(
          ...
          mat4_mul(
            mvp,
            mat4_mul(
              translation_mat4([0, main / 2 + rod + web + web, 0]),
              y_flip_mat4
            )
          ),
          y_flip_normal,
        ...
        if (!skip_mains) {
          gl.draw_mesh(
            'Crankshaft_main_journal',
            mat4_mul(mvp, translation_mat4([0, rod + web * 2 + main, 0])),
            normal,
            main_color,
            opacity
          )
        ...
        gl.draw_mesh(
          ...
          mat4_mul(
            mvp,
            mat4_mul(
              translation_mat4([0, (main * 3) / 2 + web * 2 + rod, 0]),
              rot
            )
          ),
          rot_normal,
        ...
        if (!part)
          gl.draw_mesh(
            ...
            mat4_mul(
              mvp,
              mat4_mul(translation_mat4([0, 2 * web + main + rod, 0]), rot)
            ),
            rot_normal,
            rod_color,
            opacity
        ...
        if (!part) {
          gl.draw_mesh(
            ...
            mat4_mul(
              ...
              mat4_mul(
                mat4_mul(
                  translation_mat4([0, (main * 3) / 2 + rod * 2 + web * 4, 0]),
                  rot
                ),
                y_flip_mat4
              )
          ...
          gl.draw_mesh(
            ...
            mat4_mul(
              mvp,
              translation_mat4([0, rod * 2 + web * 4 + main * 2, 0])
            ),
            normal,
            main_color,
            opacity
          ...
          gl.draw_mesh(
            ...
            mat4_mul(
              mvp,
              translation_mat4([0, rod * 2 + web * 4 + main * 2.5, 0])
            ),
            normal,
            end_color,
            opacity
      ...
      function draw_injectors(crank_angle, view_projection, rot, skip, color) {
        ...
        for (let i = 0; i < 4; i++) {
          ...
          let cylinder_phase_angle = -(
            (-Math.PI * 4 + crank_angle + cylinder_order[i] * Math.PI) %
            (Math.PI * 4)
          )
          ...
          let mat = mat4_mul(
            mat4_mul(
              ...
              translation_mat4([
                -4.563,
                cylinder_distance * 1.5 - i * cylinder_distance,
                0,
              ])
            ),
      ...
      function draw_spark_plugs(
        ...
        for (let i = 0; i < 4; i++) {
          ...
          let spark_alpha =
            step((3 + spark_time) * Math.PI, cylinder_phase_angle) -
          ...
          if (spark_alpha != 0) {
            ...
            gl.draw_mesh(
              'Spark_spark',
              mat4_mul(
                mat4_mul(mat, translation_mat4([0, 0, -2.25])),
                mat4_mul(
                  mat4_mul(
                    rot_y_mat4(h * Math.PI * 2),
                    rot_z_mat4(h * 1.4 * Math.PI * 2)
                  ),
                  scale_mat4(2.6 + h * 0.2)
                )
              ),
              rot,
              [0.5, 0.5, 1, 0.5],
            ...
            gl.draw_mesh(
              ...
              mat4_mul(
                ...
                mat4_mul(
                  mat4_mul(
                    rot_y_mat4(h * Math.PI * 2 * 17),
                    rot_z_mat4(h * 1.9 * Math.PI * 2)
                  ),
                  scale_mat4(2.3 + h * 0.1)
                )
              ),
              rot,
              [1, 1, 1, 0],
          ...
          for (let i = 0; i < 4; i++) {
            ...
            let mat = mat4_mul(
              mat4_mul(
                translation_mat4([
                  t,
                  (i - 1.5) * cylinder_distance + cam_width * 0.5 - 18,
                  117.947,
                ]),
                rot_x_mat4(Math.PI * 0.5)
              ),
              rot_z_mat4(angle)
            )
            let n_mat = mat3_mul(
              normal_rot,
              mat3_mul(rot_x_mat3(Math.PI * 0.5), rot_z_mat3(angle))
            )

            gl.draw_mesh(
              'cam_lobe',
              mat4_mul(view_projection, mat),
              n_mat,
              color
            )
            gl.draw_mesh(
              ...
              mat4_mul(
                view_projection,
                mat4_mul(translation_mat4([0, valve_distance, 0]), mat)
              ),
              n_mat,
              color
            )
            ...
            gl.draw_mesh(
              ...
              mat4_mul(
                ...
                mat4_mul(
                  mat,
                  mat4_mul(
                    translation_mat4([0, 0, -valve_distance + cam_width]),
                    scale
                  )
                )
              ),
            ...
            scale = scale_mat4([
              10,
              10,
              cylinder_distance - cam_width - valve_distance,
            ])
            ...
            if (i > 0)
              gl.draw_mesh(
                ...
                mat4_mul(
                  ...
                  mat4_mul(
                    mat,
                    mat4_mul(translation_mat4([0, 0, cam_width]), scale)
                  )
                ),
                n_mat,
                color
              ...
              gl.draw_mesh(
                ...
                mat4_mul(
                  ...
                  mat4_mul(
                    mat,
                    mat4_mul(
                      translation_mat4([00, 000, -834]),
                      rot_x_mat4(-Math.PI * 0.5)
                    )
                  )
                ),
                mat3_mul(n_mat, rot_x_mat3(-Math.PI * 0.5)),
                color
              )
              ...
              gl.draw_mesh(
                ...
                mat4_mul(
                  ...
                  mat4_mul(
                    ...
                    mat4_mul(
                      translation_mat4([
                        11 * Math.sin(knob_a[k]),
                        11 * Math.cos(knob_a[k]),
                        -4 * cylinder_distance - 7,
                      ]),
                      scale
                    )
                  )
      ...
      function draw_camshaft_caps(mvp, rot, one) {
        for (let i = 0; i < 4; i++) {
          ...
          gl.draw_mesh(
            ...
            mat4_mul(
              mvp,
              translation_mat4([0, (i - 1) * cylinder_distance, 0])
            ),
            rot,
            gray_color
          )
          draw_bolt(
            ...
            mat4_mul(
              mvp,
              translation_mat4([40.745, (i - 1.5) * cylinder_distance, 128.948])
            ),
            rot
          )
          draw_bolt(
          ...
          gl.draw_mesh(
            ...
            mat4_mul(
              mvp,
              translation_mat4([-115.49, (i - 1) * cylinder_distance, 0])
            ),
            rot,
            gray_color
          )
      ...
      function draw_piston_rings(mvp, view_projection, rot, rod_c) {
        ...
        model_matrix = mat4_mul(
          translation_mat4([0, 0, rod_c[1]]),
          model_matrix
        )
        ...
        gl.draw_ring_mesh(
          'Piston_oil_ring',
          mat4_mul(mvp, rot_y_mat4(-a)),
          mat3_mul(rot, rot_y_mat3(-a)),
          gray_color
        )
        gl.draw_ring_mesh(
          'Piston_oil_ring',
        ...
        gl.draw_ring_mesh(
          'Piston_oil_ring',
          mat4_mul(mvp, rot_y_mat4(2 * a)),
          mat3_mul(rot, rot_y_mat3(2 * a)),
          gray_color
        )
        ...
        model_matrix = mat4_mul(
          translation_mat4([0, 0, rod_c[1] - 6.5]),
          model_matrix
        )
        mvp = mat4_mul(view_projection, model_matrix)
        ...
        model_matrix = mat4_mul(rot_x_mat4(Math.PI * 0.5), scale_mat)
        model_matrix = mat4_mul(
          translation_mat4([0, 0, rod_c[1] - 9]),
          model_matrix
        )
        mvp = mat4_mul(view_projection, model_matrix)
      ...
      function draw_piston(
        ...
        if (!rod_color) rod_color = [0.8, 0.8, 0.8, 1]

        if (!piston_color) piston_color = [0.8, 0.8, 0.8, 1]
        ...
        model_matrix = mat4_mul(
          translation_mat4([0, 0, crank_length]),
          model_matrix
        )
        ...
        draw_bolt(
          ...
          0,
          mat4_mul(
            mat4_mul(mvp, translation_mat4([33, 0, -24])),
            rot_x_mat4(Math.PI)
          ),
          mat3_mul(normal_rot, rot_x_mat3(Math.PI)),
          gray_color,
          1,
          true
        )
        ...
        gl.draw_mesh(
          'Rod_top',
          mvp,
          mat3_mul(normal_rot, x_flip_mat3),
          rod_color,
          1,
          true
        )
        ...
        if (!skip_rings) {
          ...
          gl.draw_mesh(
            ...
            mat4_mul(
              ...
              mat4_mul(
                translation_mat4([0, 0, 26.5]),
                mat4_mul(rot_x_mat4(-Math.PI * 0.5), rot_z_mat4(-Math.PI))
              )
            ),
            mat3_mul(
              normal_rot,
              mat3_mul(rot_x_mat3(-Math.PI * 0.5), rot_z_mat3(-Math.PI))
            ),
            clip_color
          )
          gl.draw_mesh(
      ...
      function draw_flames(crank_angle, view_projection, rot, one) {
        ...
        for (let ii = 0; ii < 4; ii++) {
          ...
          gl.draw_flame(
            m,
            mvp,
            mat3_mul_vec(mat3_transpose(rot), [0, 0, -1]),
            [sim_t, piston_diameter * 0.5, cylinder_h * 0.5, r],
            pre_color,
            post_color,
            f0_color,
            f1_color,
          ...
          if (one) {
            let sc = 0.7
            mvp = mat4_mul(
              mat4_mul(view_projection, translation_mat4([arrow_t, 0, 30])),
      ...
      function draw_timing(angle, view_projection, rot, use_color, magic) {
        ...
        let dist = 400 + 270
        gear_mat = mat4_mul(
          mat4_mul(view_projection, translation_mat4([57.745, dist, 117.947])),
          rot_y_mat4(angle * 0.5 + 0.12631578947368421)
        )
        ...
        for (let i = 0; i < 4; i++) {
          ...
          gl.draw_mesh(
            ...
            mat,
            rot,
            use_color ? red_color : gray_color,
            1,
            i == 1 || i == 2
          )
        }
        ...
        gear_mat = mat4_mul(
          mat4_mul(view_projection, translation_mat4([-57.745, dist, 117.947])),
          rot_y_mat4(angle * 0.5 + 0.031578947368421054)
        )
        gear_rot = mat3_mul(rot, rot_y_mat3(angle * 0.5))
        ...
        gear_mat = mat4_mul(
          mat4_mul(
            view_projection,
            translation_mat4([0, dist, crankshaft_base_distance])
          ),
          rot_y_mat4(angle)
        )
        ...
        draw_bolt(
          ...
          mat4_mul(
            mat4_mul(
              view_projection,
              translation_mat4([-57.745, 260, 117.947])
            ),
            mat4_mul(rot_y_mat4(angle * 0.5), rot_x_mat4(-Math.PI * 0.5))
          ),
          mat3_mul(
            rot,
            mat3_mul(rot_y_mat3(angle * 0.5), rot_x_mat3(-Math.PI * 0.5))
          )
        )
        draw_bolt(
          4,
        ...
        for (let i = 0; i < 4; i++) {
          ...
          gl.draw_mesh(
            ...
            mat,
            rot,
            use_color ? green_color : gray_color,
            1,
            i == 1 || i == 2
          )
        }
        ...
        gl.draw_mesh(
          'Timing_belt',
          mat4_mul(view_projection, translation_mat4([0, dist, 0])),
          rot,
          use_color ? blue_color : gray_color
        )
        gl.draw_mesh(
          'Timing_belt',
          mat4_mul(
        ...
        if (magic != 3) {
          gl.draw_mesh(
            'cylinder',
            mat4_mul(
              mat4_mul(view_projection, translation_mat4([42, 250, -61.253])),
              mat4_mul(rot_x_mat4(-Math.PI * 0.5), scale_mat4([19.5, 19.5, 26]))
            ),
            mat3_mul(rot, rot_x_mat3(-Math.PI * 0.5)),
            use_color ? dark_gray_color : gray_color
          )
          gl.draw_mesh(
            'cylinder',
            mat4_mul(
              mat4_mul(view_projection, translation_mat4([42, 232, -61.253])),
              mat4_mul(rot_x_mat4(-Math.PI * 0.5), scale_mat4([10, 10, 18]))
            ),
            mat3_mul(rot, rot_x_mat3(-Math.PI * 0.5)),
            use_color ? dark_gray_color : gray_color
          )
        ...
        let roll_mat = mat4_mul(
          rot_x_mat4(Math.PI * 0.5),
          scale_mat4([1.95, 1.95, 14])
        )
        ...
        for (let k = 0; k < 2; k++) {
          while (l <= ll + pitch) {
            ...
            if (l < l0) {
              ...
              y =
                22 * Math.sin(small_angle) - 61.253 + d * Math.cos(small_angle)
            ...
            gl.draw_mesh(
              ...
              mat4_mul(
                view_projection,
                mat4_mul(
                  translation_mat4([k == 0 ? x : -x, 269.5, y]),
                  roll_mat
                )
              ),
              roll_norm,
        ...
        if (!skip_bolts) {
          for (let i = 0; i < 6; i++) {
            let mat = mat4_mul(
              mat4_mul(
                view_projection,
                rot_y_mat4((i * Math.PI) / 3 + Math.PI / 6 + crank_angle)
              ),
            ...
            draw_bolt(
              ...
              0,
              0,
              mat4_mul(mat, rot_x_mat4(Math.PI * 0.5)),
              mat3_mul(
                rot,
                mat3_mul(
                  rot_y_mat3((i * Math.PI) / 3 + Math.PI / 6 + crank_angle),
                  rot_x_mat3(Math.PI * 0.5)
                )
              ),
              gray_color
            )
      ...
      function draw_block(mvp, rot, opacity, color) {
        ...
        gl.draw_mesh(
          'Engine_block',
          mat4_mul(mvp, translation_mat4([0, -cylinder_distance, 0])),
          rot,
          color,
          opacity
        )
        gl.draw_mesh(
          ...
          mat4_mul(
            mvp,
            mat4_mul(y_flip_mat4, translation_mat4([0, -cylinder_distance, 0]))
          ),
          mat3_mul(rot, y_flip_mat3),
          color,
          opacity,
        ...
        gl.draw_mesh(
          'Engine_block',
          mat4_mul(mvp, translation_mat4([0, 2 * cylinder_distance, 0])),
          rot,
          color,
          opacity
        )
        gl.draw_mesh(
          ...
          mat4_mul(
            ...
            mat4_mul(
              y_flip_mat4,
              translation_mat4([0, 2 * cylinder_distance, 0])
            )
          ),
          mat3_mul(rot, y_flip_mat3),
          color,
      ...
      function draw_crankshaft_mount(view_projection, rot, one) {
        ...
        for (let i = 0; i < 5; i++) {
          ...
          gl.draw_mesh(
            'Main_journal_cap',
            mat4_mul(mvp, translation_mat4([0, d, 0])),
            normal_rot,
            color
          )
          gl.draw_mesh(
            'Main_journal_cap',
            mat4_mul(mat4_mul(mvp, translation_mat4([0, d, 0])), x_flip_mat4),
            mat3_mul(normal_rot, x_flip_mat3),
            color,
            1,
            true
          ...
          gl.draw_mesh(
            ...
            mat4_mul(
              mvp,
              mat4_mul(translation_mat4([d, 0, -221.5]), rot_x_mat4(Math.PI))
            ),
            mat3_mul(normal_rot, rot_x_mat3(Math.PI)),
            color
          )
          gl.draw_mesh(
            'Main_bearing_bottom',
            mat4_mul(mvp, translation_mat4([d, 0, -221.5])),
            normal_rot,
            color
          )
        }
      ...
      function draw_valves(offsets, view_projection, rot, cross, plain, color) {
        ...
        let normal_rot = mat3_mul(
          rot,
          mat3_mul(rot_y_mat3((-20 * Math.PI) / 180), rot_x_mat3(Math.PI * 0.5))
        )
        let mvp = mat4_mul(view_projection, model_matrix)
        ...
        for (let i = 0; i < 4; i++) {
          ...
          let mat = mat4_mul(
            model_matrix,
            mat4_mul(translation_mat4([0, 0, d]), rot_x_mat4(Math.PI * 0.5))
          )
          let tr = translation_mat4([
            0,
            -2 * cylinder_distance + i * cylinder_distance,
            0,
          ])
      ...
      function draw_standard_pistons(
        crank_angle,
        view_projection,
        rot,
        skip_rings,
        ...
        draw_piston(
          ...
          mat4_mul(
            view_projection,
            translation_mat4([0, main * 0.5 + web + rod * 0.5, 0])
          ),
          rot,
          rod_color,
          piston_color,
        ...
        draw_piston(
          ...
          mat4_mul(
            view_projection,
            translation_mat4([0, main * 1.5 + web * 3 + rod * 1.5, 0])
          ),
          rot,
          rod_color,
          piston_color,
      ...
      function draw_head(mvp, rot, skip_gasket, skip_bolts, opacity) {
        ...
        gl.draw_mesh(
          'Engine_head',
          mat4_mul(mvp, mat4_mul(y_flip_mat4, translation_mat4([0, 0, 0]))),
          mat3_mul(rot, y_flip_mat3),
          color,
          opacity,
          true
        ...
        if (!skip_bolts) {
          for (let i = 0; i < 5; i++) {
            draw_bolt(
              ...
              mat4_mul(
                mvp,
                translation_mat4([40, (i - 2) * cylinder_distance, 67])
              ),
              rot,
              gray_color,
              1,
      ...
      if (mode === 'cannon' || mode === 'simple_crank_cannon') {
        ...
        if (mode === 'simple_crank_cannon')
          view_projection = mat4_mul(
            translation_mat4([0, 200, 00]),
            view_projection
          )
        else
          view_projection = mat4_mul(
            translation_mat4([0, 100, 0]),
            view_projection
          )
        ...
        view_projection = mat4_mul(
          scale_mat4(mode === 'simple_crank_cannon' ? 2.4 : 2.6),
          view_projection
        )
        ...
        let m = mat4_mul(
          translation_mat4([0, 0, 0]),
          mat4_mul(rot_x_mat4(Math.PI * 0.5), scale)
        )
        mvp = mat4_mul(view_projection, m)
        mvp = mat4_mul(
          mat4_mul(view_projection, translation_mat4([0, 325, 0])),
          mat4_mul(rot_x_mat4(Math.PI * 0.5), scale)
        )
        ...
        mvp = mat4_mul(view_projection, m)
        mvp = mat4_mul(
          mat4_mul(view_projection, translation_mat4([0, 340, 0])),
          mat4_mul(rot_x_mat4(Math.PI * 0.5), scale)
        )
        ...
        if (mode === 'simple_crank_cannon') {
          ...
          gl.draw_mesh(
            'Support',
            mat4_mul(mvp, translation_mat4([0, -10, 0])),
            normal_rot,
            [0.8, 0.8, 0.8, 1]
          )
          gl.draw_mesh(
            'Support',
            mat4_mul(mvp, translation_mat4([0, -60, 0])),
            normal_rot,
            [0.8, 0.8, 0.8, 1]
          )
          ...
          if (ball_ang > 0.6706669116102514)
            ang =
              1.0490328845380197 +
              0.6 * (smooth_step(0, 0.6706669116102514 * 2, ball_ang) - 0.5)
          ...
          gl.draw_mesh(
            'cylinder',
            mat4_mul(mat4_mul(mvp, rot_x_mat4(Math.PI * 0.5)), scale),
            mat3_mul(normal_rot, rot_x_mat3(Math.PI * 0.5)),
            blue_color
          )
          ...
          gl.draw_spiral(
            mat4_mul(
              mat4_mul(
                mat4_mul(mvp, translation_mat4([0, -80, 0])),
                rot_x_mat4(Math.PI * 0.5)
              ),
              scale
            ),
        ...
        view_projection = mat4_mul(
          view_projection,
          translation_mat4([0, wire_tr, 0])
        )
        gl.draw_mesh(
          'small_cylinder',
          mat4_mul(
            mat4_mul(
              mat4_mul(view_projection, translation_mat4([0, 118, 0])),
              rot_x_mat4(-Math.PI * 0.5)
            ),
            scale_mat4([2, 2, 80])
          ),
        ...
        gl.draw_mesh(
          ...
          mat4_mul(
            mat4_mul(
              mat4_mul(view_projection, translation_mat4([-1.25, 115, 0])),
              rot_x_mat4(-Math.PI * 0.5)
            ),
            scale_mat4([0.85, 0.85, 3])
          ),
          mat3_mul(rot, rot_x_mat3(-Math.PI * 0.5)),
          gray_color
        )
        ...
        if (mode === 'stroke0') {
          ...
          valve0_tr -=
            valve_open *
            (smooth_step(0, 0.3, arg0) - smooth_step(0.7, 1.0, arg0))
          ...
          valve0_tr -=
            valve_open * (smooth_step(0, 0.3, tt) - smooth_step(0.7, 1.0, tt))
          valve1_tr -=
            valve_open *
            (smooth_step(0, 0.3, tt - 3) - smooth_step(0.7, 1.0, tt - 3))
        }
        ...
        gl.draw_mesh(
          'Simple_valve',
          mat4_mul(view_projection, valve0_transform),
          normal_rot,
          green_color
        )
        gl.draw_mesh(
          'Simple_valve',
          mat4_mul(view_projection, valve1_transform),
          normal_rot,
          yellow_color
        )
        ...
        gl.draw_mesh(
          ...
          mat4_mul(
            mat4_mul(
              mat4_mul(view_projection, translation_mat4([0, 110 + 118, 0])),
              rot_x_mat4(-Math.PI * 0.5)
            ),
            scale_mat4([2, 2, 80])
          ),
        ...
        gl.draw_mesh(
          ...
          mat4_mul(
            mat4_mul(
              mat4_mul(
                view_projection,
                translation_mat4([-1.25, 110 + 115, 0])
              ),
              rot_x_mat4(-Math.PI * 0.5)
            ),
            scale_mat4([0.85, 0.85, 3])
        ...
        gl.draw_mesh(
          ...
          mat4_mul(
            mat4_mul(
              mat4_mul(view_projection, translation_mat4([1.25, 110 + 115, 0])),
              rot_x_mat4(-Math.PI * 0.5)
            ),
            scale_mat4([0.85, 0.85, 3])
          ),
        ...
        gl.draw_mesh(
          'cylinder',
          mat4_mul(mat4_mul(mvp, translation_mat4([0, rod_c[1], -40])), scale),
          normal_rot,
          gray_color
        )
        ...
        gl.draw_mesh(
          'Simple_piston',
          mat4_mul(mvp, translation_mat4([0, rod_c[1], 0])),
          normal_rot,
          red_color
        )
        ...
        gl.draw_mesh(
          'Simple_cylinder',
          mat4_mul(mvp, translation_mat4([0, 110, 0])),
          rot,
          [0.8, 0.8, 0.8, 1],
          1,
          false
        ...
        gl.draw_mesh(
          'Simple_cylinder',
          mat4_mul(mat4_mul(mvp, translation_mat4([0, 110, 0])), x_flip_mat4),
          mat3_mul(rot, x_flip_mat3),
          [0.8, 0.8, 0.8, 1],
          1,
          true
        ...
        gl.draw_mesh(
          'Simple_crank',
          mat4_mul(mvp, translation_mat4([0, 0, -10])),
          normal_rot,
          blue_color
        )
        ...
        gl.draw_mesh(
          'cylinder',
          mat4_mul(mat4_mul(mvp, translation_mat4([0, 0, -50])), scale),
          normal_rot,
          blue_color
        )
        ...
        gl.draw_mesh(
          'cylinder',
          mat4_mul(
            mat4_mul(mvp, translation_mat4([crank_length, 0, 10])),
            scale
          ),
          normal_rot,
          blue_color
        ...
        gl.draw_mesh(
          'Simple_rod',
          mvp,
          mat3_mul(normal_rot, rot_z_mat3(rod_c[0] + Math.PI * 0.5)),
          gray_color
        )

        {
          ...
          mvp = mat4_mul(view_projection, m)
          mvp = mat4_mul(
            mat4_mul(view_projection, translation_mat4([0, 230 - 1, 0])),
            mat4_mul(rot_x_mat4(Math.PI * 0.5), scale)
          )
          gl.draw_flame(
            m,
            mvp,
            dir,
            [t * 4.0, piston_diameter * 0.5, cylinder_h * 0.5, r],
            pre_color,
            post_color,
            f0_color,
            f1_color
        ...
        if (spark_alpha != 0) {
          ...
          gl.draw_mesh(
            'Spark_spark',
            mat4_mul(
              mat4_mul(view_projection, translation_mat4([0, 226, 00])),
              mat4_mul(
                mat4_mul(
                  rot_y_mat4(h * Math.PI * 2),
                  rot_z_mat4(h * 1.4 * Math.PI * 2)
          ...
          gl.draw_mesh(
            'Spark_spark',
            mat4_mul(
              mat4_mul(view_projection, translation_mat4([0, 226, 0])),
              mat4_mul(
                mat4_mul(
                  rot_y_mat4(h * Math.PI * 2 * 17),
                  rot_z_mat4(h * 1.9 * Math.PI * 2)
        ...
        if (block) {
          ...
          view_projection = mat4_mul(
            view_projection,
            translation_mat4([0, 0, crankshaft_base_distance])
          )
            ...
            gl.draw_mesh(
              ...
              mat4_mul(
                mat4_mul(
                  ...
                  translation_mat4([
                    0,
                    cylinder_distance * (i - 1.5),
                    -crank_length + rod_length + piston_height - 1,
                  ])
                ),
                scale
              ),
        ...
        for (let i = 0; i < 4; i++) {
          ...
          gl.draw_mesh(
            'Rod_bottom',
            mat4_mul(mvp, translation_mat4([0, 0, -top_tr + bottom_tr])),
            normal_rot,
            blue_color
          )
          draw_bolt(
            ...
            33,
            mat4_mul(
              mat4_mul(mvp, translation_mat4([33, 0, -24 - top_tr + bolt_tr])),
              mat4_mul(rot_z_mat4(screw_rot), rot_x_mat4(Math.PI))
            ),
            mat3_mul(
              normal_rot,
              mat3_mul(rot_z_mat3(screw_rot), rot_x_mat3(Math.PI))
            ),
            gray_color,
            1,
            true
          ...
          gl.draw_mesh(
            'Rod_bearing',
            mat4_mul(mvp, translation_mat4([0, 0, -bearing_tr])),
            normal_rot,
            red_color
          )
          gl.draw_mesh(
            ...
            mat4_mul(
              mat4_mul(
                mvp,
                translation_mat4([0, 0, -top_tr + bottom_tr + bearing_tr])
              ),
              rot_x_mat4(Math.PI)
            ),
            mat3_mul(normal_rot, rot_x_mat3(Math.PI)),
          ...
          model_matrix = mat4_mul(
            translation_mat4([0, dx, 0]),
            rot_x_mat4(Math.PI * 0.5)
          )
          model_matrix = mat4_mul(
            translation_mat4([0, 0, top_tr + rod_length]),
            model_matrix
          )
          mvp = mat4_mul(view_projection, model_matrix)
          ...
          gl.draw_mesh(
            'Piston',
            mat4_mul(mvp, x_flip_mat4),
            mat3_mul(piston_rot, x_flip_mat3),
            yellow_color,
            1,
            true
          )
          ...
          draw_piston_rings(
            mvp,
            mat4_mul(view_projection, translation_mat4([0, dx, 0])),
            rot,
            [0, top_tr + rod_length]
          )
        }
        ...
        let bottom_bearing_tr =
          95 +
          65 * smooth_step(0.0, 0.25, arg0) -
          160 * smooth_step(0.5, 0.75, arg0)
        ...
        let view_projection = translation_mat4([
          -crank_left * 0.4,
          0,
          200 - 80 * smooth_step(0.6, 0.9, arg0),
        ])
        view_projection = mat4_mul(mat3_to_mat4(rot), view_projection)
        view_projection = mat4_mul(
          scale_mat4(3.5 + 1.5 * smooth_step(0.7, 1.0, arg0)),
          view_projection
        )
        view_projection = mat4_mul(proj, view_projection)
        let model_matrix
        ...
        for (let i = 0; i < 5; i++) {
          ...
          gl.draw_mesh(
            'Main_journal_cap',
            mat4_mul(mvp, translation_mat4([0, d, -cap_tr])),
            normal_rot,
            blue_color
          )
          gl.draw_mesh(
            ...
            mat4_mul(
              mat4_mul(
                ...
                translation_mat4([
                  -42,
                  d - cylinder_distance,
                  -47 + crankshaft_base_distance - screw_tr,
                ])
              ),
              mat4_mul(rot_z_mat4(screw_rot), rot_x_mat4(Math.PI))
            ),
            mat3_mul(
              mat3_mul(normal_rot, rot_z_mat3(screw_rot)),
              rot_x_mat3(Math.PI)
            ),
            green_color,
            1,
          ...
          gl.draw_mesh(
            'Main_bearing_top',
            mat4_mul(mvp, translation_mat4([d, 0, -221.5 - top_bearing_tr])),
            normal_rot,
            red_color
          )
          gl.draw_mesh(
            'Main_bearing_bottom',
            mat4_mul(mvp, translation_mat4([d, 0, -221.5 - bottom_bearing_tr])),
            normal_rot,
            red_color
          )
        }
        ...
        draw_crankshaft(
          mat4_mul(
            ...
            translation_mat4([
              crank_left,
              0,
              crankshaft_base_distance - crank_down,
            ])
          ),
          rot,
          false,
...

        {
          ...
          mvp = mat4_mul(
            view_projection,
            translation_mat4([0, 0, lerp(150, 0, t0)])
          )
          ...
          gl.draw_mesh(
            ...
            mat4_mul(
              ...
              mat4_mul(
                y_flip_mat4,
                translation_mat4([0, -cylinder_distance, 0])
              )
            ),
            mat3_mul(rot, y_flip_mat3),
            color,
        ...
        mvp = mat4_mul(
          view_projection,
          translation_mat4([0, 0, lerp(300, 0, t1)])
        )
          ...
          draw_bolt(
            ...
            mat4_mul(
              mat4_mul(
                ...
                translation_mat4([
                  40,
                  (i - 2) * cylinder_distance,
                  (1 - t) * 250 + 67,
                ])
              ),
              rot_z_mat4(-t * 20)
            ),
            mat3_mul(rot, rot_z_mat3(-t * 20)),
            red_color,
            1,
            true
          )
          t = smooth_step(
            0.6 + (0.2 * order[i * 2 + 1]) / 9,
            0.8 + (0.2 * order[i * 2 + 1]) / 9,
            arg0
          )
          draw_bolt(
            5.5,
        ...
        draw_crankshaft(
          mvp,
          mat3_mul(rot, rot_y_mat3(crank_angle)),
          false,
          true
        )
        ...
        let offsets = vec_lerp(
          valve_offsets(crank_angle),
          [0, 0, 0, 0, 0, 0, 0, 0],
          sharp_step(0, 5, cam_t)
        )
        draw_block(view_projection, rot)
        draw_crankshaft_mount(view_projection, rot)
        ...
        draw_camshafts(
          crank_angle,
          mat4_mul(view_projection, translation_mat4([0, 0, cam_t])),
          rot,
          false,
          yellow_color
        )
        ...
        let s0 = lerp(
          1.03,
          1.08,
          smooth_step(0.6, 0.7, arg0) - smooth_step(0.9, 1.0, arg0)
        )
        let s1 = lerp(
          1.03,
          1.08,
          smooth_step(0.3, 0.4, arg0) - smooth_step(0.6, 0.7, arg0)
        )
        let s2 = lerp(
          1.03,
          1.08,
          smooth_step(0.0, 0.1, arg0) - smooth_step(0.3, 0.4, arg0)
        )
        ...
        if (mode === 'oil_ring') {
          ...
          gl.draw_mesh(
            'Piston_lines_2',
            mat4_mul(mvp, z_flip_mat4),
            mat3_mul(rot, z_flip_mat3),
            gray_color,
            1,
            true,
            [
        ...
        gl.draw_ring_mesh('Piston_ring', mvp, rot, red_color, 1, [
          1 - 1 / s0,
          piston_diameter * (s0 - 1),
        ])
        ...
        gl.draw_ring_mesh('Piston_oil_ring', mvp, rot, red_color, 1, [
          1 - 1 / s2,
          piston_diameter * (s2 - 1),
        ])
        gl.draw_ring_mesh(
          'Piston_oil_ring',
          mat4_mul(mvp, rot_y_mat4(-a)),
        ...
        let s0 = lerp(1.03, 1.0, t0)

        let scale = 10.0 + t2 * 60

        rot = mat3_mul(
          rot_x_mat3(Math.PI * (0.25 + t2 * 0.25)),
          mat3_mul(rot_y_mat3(-Math.PI * 0.25), rot_x_mat3(-Math.PI * 0.5))
        )

        let view_projection = translation_mat4([
          0,
          cylinder_distance * 0.5 + piston_diameter * 0.45 * t2,
          0,
        ])
        view_projection = mat4_mul(mat3_to_mat4(rot), view_projection)
        view_projection = mat4_mul(scale_mat4(scale), view_projection)
        ...
        let model_matrix
        model_matrix = mat4_mul(
          translation_mat4([0, -cylinder_distance * 0.5, ring0_tr]),
          rot_x_mat4(Math.PI * 0.5)
        )
        mvp = mat4_mul(view_projection, model_matrix)
        ...
        let rot = mat3_mul(
          rot_x_mat3(
            2.4 + (Math.PI * (5 / 6) - 2.4) * smooth_step(0.7, 1.0, arg0)
          ),
        ...
        model_matrix = mat4_mul(
          translation_mat4([0, 0, crankshaft_base_distance - (1 - s) * 40]),
          model_matrix
        )
        mvp = mat4_mul(view_projection, model_matrix)
        ...
        gl.draw_mesh(
          'Main_bearing_top',
          mvp,
          mat3_mul(rot, rot_z_mat3(-Math.PI * 0.5)),
          red_color
        )
        ...
        gl.draw_mesh(
          ...
          mat4_mul(
            mvp,
            mat4_mul(
              mat4_mul(y_flip_mat4, x_flip_mat4),
              translation_mat4([0, cylinder_distance, 0])
            )
          ),
          mat3_mul(rot, mat3_mul(y_flip_mat3, x_flip_mat3)),
          color,
          opacity,
          false,
          [
        ...
        gl.draw_mesh(
          ...
          mat3_mul(rot, rot_z_mat3(Math.PI)),
          color,
          1,
          false,
          [
        ...
        for (let i = 0; i < 4; i++) {
          ...
          let mat = mat4_mul(
            ...
            mat4_mul(
              rot_y_mat4(ang),
              translation_mat4([0, 0, 150 * t + 47.054 - 33])
            )
          )
        ...
        for (let i = 0; i < 4; i++) {
          ...
          let mat = mat4_mul(
            ...
            mat4_mul(
              rot_y_mat4(ang),
              translation_mat4([0, 0, 150 * t + 37 - 20])
            )
          )
        ...
        let l = Math.sqrt(
          Math.pow(rod * 0.5 + main * 0.5 + web, 2) +
        ...
        for (let i = 0; i < 4; i++) {
          ...
          gl.draw_oil(
            mat4_mul(
              mat4_mul(mvp, translation_mat4([-31, tr * (i - 1), 0])),
              mat4_mul(rot_y_mat4(Math.PI * 0.5), scale)
            ),
          ...
          gl.draw_oil(
            mat4_mul(
              mat4_mul(view_projection, rot_y_mat4(-Math.PI / 6)),
              mat4_mul(translation_mat4([0, tr * (i - 1), 31]), scale)
            ),
            mat3_mul(normal_rot, rot_y_mat3(Math.PI * 0.5)),
            color,
            opacity,
          ...
          gl.draw_oil(
            mat4_mul(
              mat4_mul(mvp, translation_mat4([0, tr * (i - 1), 0])),
              mat4_mul(
                rot_x_mat4(i == 0 || i == 3 ? Math.PI - angle : angle),
                scale
              )
            ),
            mat3_mul(
              normal_rot,
              rot_x_mat3(i == 0 || i == 3 ? Math.PI - angle : angle)
            ),
            color,
            opacity,
            false,
          ...
          gl.draw_oil(
            mat4_mul(
              mat4_mul(
                mat4_mul(
                  mvp,
                  rot_y_mat4(Math.PI * 0.5 * (i == 0 || i == 3 ? 1 : -1))
                ),
                translation_mat4([
                  crank_length,
                  tr * (i - 1) - web - rod * 0.5 - main * 0.5,
                  -26,
                ])
              ),
              scale
            ...
            mat3_mul(
              normal_rot,
              rot_y_mat3(Math.PI * 0.5 * (i == 0 || i == 3 ? 1 : -1))
            ),
            color,
            opacity,
            false,
          ...
          gl.draw_oil(
            mat4_mul(
              mat4_mul(mvp, translation_mat4([0, tr * (i - 1) + main / 2, 0])),
              mat4_mul(rot_x_mat4(Math.PI * 0.5), scale)
            ),
            mat3_mul(normal_rot, rot_x_mat3(Math.PI * 0.5)),
            color,
          ...
          gl.draw_oil(
            mat4_mul(
              mat4_mul(
                ...
                translation_mat4([
                  0,
                  tr * (i - 2) + main / 2 + web + rod,
                  i == 0 || i == 3 ? -crank_length : crank_length,
                ])
              ),
              mat4_mul(rot_x_mat4(Math.PI * 0.5), scale)
            ),
        ...
        for (let i = 0; i < 4; i++) {
          ...
          gl.draw_oil(
            mat4_mul(
              mat4_mul(mvp, translation_mat4([0, tr * (i - 1) + 5 / 2, 0])),
              mat4_mul(
                mat4_mul(rot_y_mat4(-Math.PI * 0.5), rot_x_mat4(Math.PI * 0.5)),
                scale
              )
            ),
            mat3_mul(
              normal_rot,
              mat3_mul(rot_y_mat3(-Math.PI * 0.5), rot_x_mat3(Math.PI * 0.5))
            ),
            color,
            opacity,
            true,
        ...
        gl.draw_mesh(
          'Main_bearing_top',
          mat4_mul(mvp, translation_mat4([0, 0, 7])),
          rot,
          color
        )
        gl.draw_mesh(
        ...
        gl.draw_mesh(
          'Support',
          mat4_mul(mvp, translation_mat4([0, -20, 0])),
          rot,
          [0.8, 0.8, 0.8, 1]
        )
        gl.draw_mesh(
          'Support',
          mat4_mul(mvp, translation_mat4([0, -55, 0])),
          rot,
          [0.8, 0.8, 0.8, 1]
        )
        gl.draw_mesh(
        ...
        gl.draw_mesh(
          ...
          mat4_mul(
            mat4_mul(
              mvp,
              mat4_mul(translation_mat4([-8, 40, 39]), scale_mat4([sc, sc, sc]))
            ),
            mat4_mul(rot_y_mat4(Math.PI), rot_x_mat4(Math.PI * 0.5))
          ),
          mat3_mul(
            rot,
            mat3_mul(rot_y_mat3(Math.PI), rot_x_mat3(Math.PI * 0.5))
          ),
          green_color
        )
        ...
        gl.draw_mesh(
          'cylinder',
          mat4_mul(
            mat4_mul(mvp, translation_mat4([0, rod_length, -140 + t1 * 100])),
            scale
          ),
          normal_rot,
          yellow_color
        ...
        gl.draw_mesh(
          'Simple_piston',
          mat4_mul(mvp, translation_mat4([0, rod_length + (1 - t0) * 20, 0])),
          normal_rot,
          red_color
        )
        gl.draw_mesh(
          'Simple_rod',
          mat4_mul(mvp, translation_mat4([0, -(1 - t0) * 20, 0])),
          normal_rot,
          green_color
        )
        ...
        gl.draw_mesh(
          'Simple_cylinder_plain',
          mat4_mul(mvp, mat4_mul(translation_mat4([0, 110, 0]), x_flip_mat4)),
          mat3_mul(normal_rot, x_flip_mat3),
          [0.8, 0.8, 0.8, 1],
          1,
          true,
        ...
        if (mode === 'simple_stroke_down') {
          ...
          mvp = mat4_mul(view_projection, m)
          mvp = mat4_mul(
            mat4_mul(view_projection, translation_mat4([0, 230, 0])),
            mat4_mul(rot_x_mat4(Math.PI * 0.5), scale)
          )
        ...
        gl.draw_mesh(
          'Simple_cylinder',
          mat4_mul(mat4_mul(mvp, z_flip_mat4), x_flip_mat4),
          mat3_mul(rot, mat3_mul(z_flip_mat3, x_flip_mat3)),
          [0.8, 0.8, 0.8, 1],
          1,
          false
        )
        ...
        gl.draw_mesh(
          'Valve',
          mat4_mul(mvp, translation_mat4([0, 0, 20])),
          rot,
          blue_color
        )
        ...
        if (spark_alpha != 0) {
          gl.draw_mesh(
            'Spark_spark',
            mat4_mul(
              mat4_mul(mvp, translation_mat4([0, 0, -2.25])),
              mat4_mul(
                mat4_mul(
                  rot_y_mat4(h * Math.PI * 2),
                  rot_z_mat4(h * 1.4 * Math.PI * 2)
                ),
                scale_mat4(0.6 + h * 0.2)
              )
            ),
            rot,
            [0.5, 0.5, 1, 0.5],
        ...
        let shift =
          0.5 * (smooth_step(0.3, 0.35, tt) - smooth_step(0.6, 0.65, tt))
        ...
        gl.draw_mesh(
          'Injector_needle',
          mat4_mul(mvp, translation_mat4([0, 0, shift])),
          rot,
          yellow_color,
          1,
          false,
        ...
        gl.draw_mesh(
          'Injector_needle',
          mat4_mul(mat4_mul(mvp, y_flip_mat4), translation_mat4([0, 0, shift])),
          mat3_mul(rot, y_flip_mat3),
          yellow_color,
          1,
          true
        ...
        gl.draw_spring(
          ...
          0.3,
          len,
          mat4_mul(mvp, translation_mat4([0, 0, shift + 53.5])),
          rot,
          blue_color
        )
        ...
        gl.draw_spring(
          ...
          0.25,
          5.6,
          mat4_mul(mvp, translation_mat4([0, 0, 48.4])),
          rot,
          coil_color,
          coil_opacity,
          [16, 0]
        ...
        gl.draw_spring(
          ...
          0.25,
          5.6,
          mat4_mul(mvp, translation_mat4([0, 0, 48.9])),
          rot,
          coil_color,
          coil_opacity,
          [16, 0]
        ...
        let retainer_tr =
          30 * (1.0 - smooth_step(0, 0.25, arg0)) -
          8 * (1.0 - smooth_step(0.5, 0.75, arg0))
        ...
        let view_projection = translation_mat4([
          0,
          -75 + 25 * smooth_step(0.75, 1.0, arg0),
          0,
        ])
        view_projection = mat4_mul(mat3_to_mat4(rot), view_projection)
        view_projection = mat4_mul(scale_mat4(scale), view_projection)
        ...
        mvp = mat4_mul(
          view_projection,
          mat4_mul(model_matrix, rot_x_mat4(-Math.PI * 0.5))
        )
        gl.draw_spring(
          8,
          1.5,
        ...
        model_matrix = mat4_mul(
          rot_y_mat4(Math.PI),
          translation_mat4([0, 0, collet_tr])
        )
        mvp = mat4_mul(view_projection, model_matrix)
        gl.draw_mesh(
          'Valve_collet',
          mvp,
          mat3_mul(rot, rot_y_mat3(Math.PI)),
          red_color
        )
        ...
        gl.draw_mesh(
          'Valve_retainer',
          mat4_mul(mvp, rot_y_mat4(Math.PI)),
          mat3_mul(rot, rot_y_mat3(Math.PI)),
          yellow_color
        )
        ...
        let s0 =
          1.0 -
          0.15 * (smooth_step(0.5, 0.6, arg0) - smooth_step(0.8, 0.9, arg0))

        let tr = lerp(20, 0, t2)
        let mvp
        let model_matrix = ident_mat4
        model_matrix = mat4_mul(
          translation_mat4([0, 0, -rod_length - lerp(50, 0, t0)]),
          model_matrix
        )
        ...
        let view_projection = translation_mat4([
          0,
          0,
          60 - 10 * smooth_step(0.9, 1.0, arg0),
        ])
        view_projection = mat4_mul(mat3_to_mat4(rot), view_projection)
        view_projection = mat4_mul(scale_mat4(scale), view_projection)
        view_projection = mat4_mul(proj, view_projection)
        ...
        model_matrix = rot_x_mat4(Math.PI * 0.5)
        model_matrix = mat4_mul(
          translation_mat4([0, 0, lerp(30, 0, t0)]),
          model_matrix
        )
        mvp = mat4_mul(view_projection, model_matrix)
        ...
        gl.draw_mesh(
          'Piston_pin',
          mat4_mul(mvp, translation_mat4([0, 0, lerp(60, 0, t1)])),
          normal_rot,
          green_color
        )
        ...
        gl.draw_ring_mesh(
          ...
          mat4_mul(
            mvp,
            mat4_mul(
              translation_mat4([0, 0, 26.5 + tr * 4]),
              rot_x_mat4(-Math.PI * 0.5)
            )
          ),
          mat3_mul(normal_rot, rot_x_mat3(-Math.PI * 0.5)),
        ...
        if (mode === 'cam') {
          model_matrix = mat4_mul(
            translation_mat4([0, 100 + cam_r, -10]),
            rot_z_mat4(cam_angle)
          )
          mvp = mat4_mul(view_projection, model_matrix)
          ...
          gl.draw_mesh(
            'cylinder',
            mat4_mul(mat4_mul(mvp, translation_mat4([0, 0, cam_width])), scale),
            normal_rot,
            yellow_color
          )
          gl.draw_mesh(
            'cylinder',
            mat4_mul(mat4_mul(mvp, translation_mat4([0, 0, -30])), scale),
            normal_rot,
            yellow_color
          )
        }
        ...
        draw_camshafts(
          crank_angle,
          base_view_projection,
          rot,
          false,
          mode === 'firing' ? gray_color : yellow_color
        )
        if (mode === 'cam_belt') draw_camshaft_caps(base_view_projection, rot)
        ...
        for (let k = 0; k < 2; k++) {
          ...
          if (k == 1) {
            let mm = mat4_mul(
              mat4_mul(view_projection, rot_y_mat4(crank_angle)),
              mat4_mul(
                translation_mat4([0, 400, -16]),
                mat4_mul(rot_x_mat4(Math.PI * 0.5), scale_mat4([1.5, 1.5, 2]))
              )
            )
            ...
            let mm = mat4_mul(
              mat4_mul(
                mat4_mul(
                  base_view_projection,
                  translation_mat4([57.745, 400, 117.947])
                ),
                rot_y_mat4(crank_angle * 0.5)
              ),
              mat4_mul(
                translation_mat4([0, 0, -35.5]),
                mat4_mul(rot_x_mat4(Math.PI * 0.5), scale_mat4([1.5, 1.5, 2]))
              )
            )
        ...
        draw_flywheel(
          crank_angle,
          mat4_mul(view_projection, translation_mat4([0, -t0 * 100, 0])),
          rot,
          true,
          red_color
        )
        ...
        for (let i = 0; i < 6; i++) {
          let mat = mat4_mul(
            mat4_mul(
              view_projection,
              rot_y_mat4((i * Math.PI) / 3 + Math.PI / 6)
            ),
          ...
          draw_bolt(
            ...
            mat3_mul(
              rot,
              mat3_mul(
                rot_y_mat3((i * Math.PI) / 3 + Math.PI / 6 + ang),
                rot_x_mat3(Math.PI * 0.5)
              )
            ),
            yellow_color
        ...
        gear_mat = mat4_mul(
          mat4_mul(
            mat4_mul(view_projection, rot_y_mat4(-Math.PI / 6)),
            translation_mat4([127.833, dist, 0])
          ),
          rot_y_mat4(-crank_angle * 12 + Math.PI / 12)
        )
        gear_rot = mat3_mul(
          rot,
          rot_y_mat3(-crank_angle * 12 + Math.PI / 12 - Math.PI / 6)
        )
      ...
      if (mode === 'hero') {
        ...
        gl.draw_mesh(
          'Valve',
          mat4_mul(mvp, translation_mat4([0, -1 - 10 * (1 - +arg0), 0])),
          rot,
          red_color,
          1,
          false,
        ...
        gl.draw_mesh(
          'Valve_seat',
          mat4_mul(mvp, rot_x_mat4(-Math.PI * 0.5)),
          mat3_mul(rot, rot_x_mat3(-Math.PI * 0.5)),
          [0.9, 0.9, 0.9, 1],
          1,
          false,
        ...
        gl.draw_mesh(
          'Valve_retainer_lines',
          mat4_mul(mvp, mat4_mul(translation_mat4([0, -d, 0]), x_flip_mat4)),
          mat3_mul(rot, x_flip_mat3),
          yellow_color,
          1,
          true,
        ...
        for (let i = 0; i < 5; i++) {
          gl.draw_mesh(
            ...
            mat4_mul(
              ...
              mat4_mul(
                mat4_mul(
                  translation_mat4([(i - 2) * 15, 250, -185 + rod_c[1]]),
                  scale_mat4(arrow_scale)
                ),
            ...
            mat3_mul(
              rot,
              mat3_mul(rot_x_mat3(Math.PI * 0.5), rot_z_mat3(Math.PI * 0.5))
            ),
            arrow_color
          )
        }
        ...
        gl.draw_mesh(
          ...
          mat4_mul(
            ...
            mat4_mul(
              mat4_mul(
                translation_mat4([0, 300, -220 + rod_c[1]]),
                mat4_mul(
                  mat4_mul(
                    rot_y_mat4(Math.PI + rod_c[0] + crank_angle),
                    translation_mat4([0, 0, -90])
                  ),
                  scale_mat4(big_arrow_scale)
                )
              ),
              mat4_mul(rot_x_mat4(Math.PI * 0.5), rot_z_mat4(Math.PI * 0.5))
            )
        ...
        if (mode === 'crankshaft_torque') {
          ...
          ctx.lineTo(
            p[0] * width * 0.5 + rr * Math.cos(rod_c[0] + crank_angle),
            -p[1] * height * 0.5 - rr * Math.sin(rod_c[0] + crank_angle)
          )
          ...
          ctx.lineTo(
            p2[0] * width * 0.5 + height * Math.sin(rod_c[0] + crank_angle),
            -p2[1] * height * 0.5 + height * Math.cos(rod_c[0] + crank_angle)
          )
          ctx.stroke()
        ...
        let p1 = mat4_mul_vec4(view_projection, [
          0,
          0,
          -crank_length + rod_length + piston_height,
          1,
        ])
        let p2 = mat4_mul_vec4(view_projection, [
          0,
          0,
          +crank_length + rod_length + piston_height,
          1,
        ])
        let p3 = mat4_mul_vec4(view_projection, [
          0,
          0,
          +rod_length + piston_height,
          1,
        ])
        ...
        ctx.fillText(
          'min',
          -width * 0.3,
          -p1[1] * height * 0.5 + font_size * 0.23
        )
        ctx.fillText(
          'max',
          -width * 0.3,
          -p2[1] * height * 0.5 + font_size * 0.23
        )
        ctx.fillText(
          'mid',
          -width * 0.3,
          -p3[1] * height * 0.5 + font_size * 0.23
        )
        ...
        let f = function (a) {
          ...
          let p =
            6 * nt * t * t * t * t * t +
            t * t * t * t * t * t +
            0.2 * 15 * nt * nt * t * t * t * t +
            arg1 * 0.4 * 20 * nt * nt * nt * t * t * t +
            +arg1 * 0.05 * 6 * nt * nt * nt * nt * nt * t
        ...
        ctx.arc(
          ...
          0,
          r * s - 2 / s,
          (+(shift * 0.8 + 45) * Math.PI) / 180,
          Math.PI * 0.5 - ((shift * 0.8 - 45) * Math.PI) / 180
        )
        ctx.stroke()
        ...
        ctx.fillEllipse(
          ((base_a * 0.5) / Math.PI - 0.5) * width * 0.9,
          height * 0.5 + 90 * s + dot_y * s,
          3
        )
  ...
  document.addEventListener('DOMContentLoaded', function (event) {
    let valve_timing = new Drawer(
      document.getElementById('ice_valve_timing'),
      'valve_timing'
    )
    new Slider(
      document.getElementById('ice_valve_timing_sl0'),
      function (x) {
    ...
    function slider_tick(timestamp) {
      if (!slider_animated) return

      if (prev_t != 0.0) slider_t += timestamp - prev_t
      prev_t = timestamp
...
function ice_head0() {
  head_section.set_rot(
    mat3_mul(
      rot_x_mat3(-1.2),
      mat3_mul(rot_z_mat3(Math.PI * 0.5), rot_x_mat3(Math.PI))
    )
  )
}
