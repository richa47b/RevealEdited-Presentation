...
;(function () {
  ...
  function GLDrawer(scale, ready_callback) {
    ...
    download_file(
      '/ciechanow.ski_ice_simple_assembly/internal-combustion-engine/models/ice_vertices.dat',
      function (buffer) {
    ...
    download_file(
      '/ciechanow.ski_ice_simple_assembly/internal-combustion-engine/models/ice_indices.dat',
      function (buffer) {
...
`
  ...
  document.addEventListener('DOMContentLoaded', function (event) {
    let simple_assembly = new Drawer(
      document.getElementById('ice_simple_assembly'),
      'simple_assembly'
    )
    new Slider(
      document.getElementById('ice_simple_assembly_sl0'),
      function (x) {
