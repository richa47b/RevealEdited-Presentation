...
(function() {
    ...
    function GLDrawer(scale, ready_callback) {
        ...
        download_file("/ciechanow.ski/internal-combustion-engine/models/ice_vertices.dat", function(buffer) {
        ...
        download_file("/ciechanow.ski/internal-combustion-engine/models/ice_indices.dat", function(buffer) {
...
`;
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        ...
        window.cannon = new Drawer(document.getElementById("ice_cannon"), "cannon");
