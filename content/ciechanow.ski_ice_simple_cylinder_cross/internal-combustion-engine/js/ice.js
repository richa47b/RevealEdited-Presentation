...
;(function () {
  ...
  function GLDrawer(scale, ready_callback) {
    ...
    download_file(
      '/ciechanow.ski_ice_simple_cylinder_cross/internal-combustion-engine/models/ice_vertices.dat',
      function (buffer) {
    ...
    download_file(
      '/ciechanow.ski_ice_simple_cylinder_cross/internal-combustion-engine/models/ice_indices.dat',
      function (buffer) {
...
`
  ...
  document.addEventListener('DOMContentLoaded', function (event) {
    let simple_cylinder_cross = new Drawer(
      document.getElementById('ice_simple_cylinder_cross'),
      'simple_cylinder_cross'
    )
