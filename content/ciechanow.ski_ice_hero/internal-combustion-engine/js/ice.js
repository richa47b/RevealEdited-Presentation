...
;(function () {
  ...
  function GLDrawer(scale, ready_callback) {
    ...
    download_file(
      '/ciechanow.ski_ice_hero/internal-combustion-engine/models/ice_vertices.dat',
      function (buffer) {
    ...
    download_file(
      '/ciechanow.ski_ice_hero/internal-combustion-engine/models/ice_indices.dat',
      function (buffer) {
