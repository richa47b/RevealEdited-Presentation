/*! svg.js v2.3.0 MIT*/ !(function (t, e) {
  ...
  function h(t, e, i) {
    return (
      null == i
        ? (i = (t.height / t.width) * e)
        : null == e && (e = (t.width / t.height) * i),
      { width: e, height: i }
    );
  }
  function u(t, e, i) {
  ...
  function d(t) {
    return (
      (t = t
        .replace(v.regex.whitespace, "")
        .replace(v.regex.matrix, "")
        .split(v.regex.matrixElements)),
      l(
        v.utils.map(t, function (t) {
          return parseFloat(t);
        })
      )
    );
  ...
  var v = (this.SVG = function (t) {
    return v.supported
      ? ((t = new v.Doc(t)), v.parser || v.prepare(t), t)
      : void 0;
  });
  if (
    ((v.ns = "http://www.w3.org/2000/svg"),
    (v.xmlns = "http://www.w3.org/2000/xmlns/"),
    (v.xlink = "http://www.w3.org/1999/xlink"),
    (v.svgjs = "http://svgjs.com/svgjs"),
    (v.supported = (function () {
      return (
        !!e.createElementNS && !!e.createElementNS(v.ns, "svg").createSVGRect
      );
    })()),
    !v.supported)
  )
  ...
  (v.did = 1e3),
    ...
    (v.invent = function (t) {
      ...
      return (
        ...
        t.extend && v.extend(e, t.extend),
        t.construct && v.extend(t.parent || v.Container, t.construct),
        e
      );
    }),
    (v.adopt = function (t) {
      ...
      return (
        (e =
          "svg" == t.nodeName
            ? t.parentNode instanceof SVGElement
              ? new v.Nested()
              : new v.Doc()
            : "linearGradient" == t.nodeName
            ? new v.Gradient("linear")
            : "radialGradient" == t.nodeName
            ? new v.Gradient("radial")
            : v[s(t.nodeName)]
            ? new v[s(t.nodeName)]()
            : new v.Element(t)),
        (e.type = t.nodeName),
        (e.node = t),
        (t.instance = e),
        e instanceof v.Doc && e.namespace().defs(),
        e.setData(JSON.parse(t.getAttribute("svgjs:data")) || {}),
        e
      );
    }),
    (v.prepare = function (t) {
      var i = e.getElementsByTagName("body")[0],
        n = (i ? new v.Doc(i) : t.nested()).size(2, 0),
        r = v.create("path");
    ...
    (v.Color = function (t) {
      ...
      (this.r = 0),
        ...
        (this.b = 0),
        "string" == typeof t
          ? v.regex.isRgb.test(t)
            ? ((e = v.regex.rgb.exec(t.replace(/\s/g, ""))),
              (this.r = parseInt(e[1])),
              (this.g = parseInt(e[2])),
              (this.b = parseInt(e[3])))
            : v.regex.isHex.test(t) &&
              ((e = v.regex.hex.exec(a(t))),
    ...
    (v.PointArray.prototype = new v.Array()),
    v.extend(v.PointArray, {
      toString: function () {
        for (var t = 0, e = this.value.length, i = []; e > t; t++)
      ...
      bbox: function () {
        return (
          v.parser.poly.setAttribute("points", this.toString()),
          v.parser.poly.getBBox()
        );
      },
    }),
    ...
    (v.PathArray.prototype = new v.Array()),
    v.extend(v.PathArray, {
      toString: function () {
        return p(this.value);
      },
      move: function (t, e) {
      ...
      parse: function (t) {
        ...
        if ("string" == typeof t) {
          for (
            t = t
              .replace(v.regex.negExp, "X")
              .replace(v.regex.pathLetters, " $& ")
              .replace(v.regex.hyphen, " -")
              .replace(v.regex.comma, " ")
              .replace(v.regex.X, "e-")
              .trim()
              .split(v.regex.whitespaces),
              e = t.length;
            --e;
        ...
        do {
          ...
          r == s[0]
            ...
            ? ((s[1] += o),
              (s[2] += h),
              null != s[3] && ((s[3] += o), (s[4] += h)),
              null != s[5] && ((s[5] += o), (s[6] += h)),
              (o = s[u[s[0]] - 1]),
              (h = s[u[s[0]]]))
            : "v" == r
            ? ((s[1] += h), (h = s[1]))
      ...
      bbox: function () {
        return (
          v.parser.path.setAttribute("d", this.toString()),
          v.parser.path.getBBox()
        );
      },
    }),
    (v.Number = v.invent({
        ...
        (this.value = 0),
          ...
          "number" == typeof t
            ? (this.value = isNaN(t)
                ...
                : 3.4e38)
            : "string" == typeof t
            ? ((e = t.match(v.regex.numberAndUnit)),
              e &&
      ...
      extend: {
        ...
        at: function (t) {
          return this.destination
            ? new v.Number(this.destination).minus(this).times(t).plus(this)
            : this;
        },
      },
    })),
      ...
      create: function (t) {
        ...
        if (t instanceof v.Element) {
          for (
            o = t,
              h = t,
              a = (t.attr("viewBox") || "").match(f),
              s = t.bbox,
              n = new v.Number(t.width()),
              r = new v.Number(t.height());
            "%" == n.unit;

          )
            (l *= n.value),
              (n = new v.Number(
                o instanceof v.Doc ? o.parent().offsetWidth : o.parent().width()
              )),
              (o = o.parent());
          for (; "%" == r.unit; )
            (c *= r.value),
    ...
    (v.Element = v.invent({
      create: function (t) {
        (this._stroke = v.defaults.attrs.stroke),
          (this.dom = {}),
          (this.node = t) &&
      ...
      extend: {
        ...
        size: function (t, e) {
          ...
          return this.width(new v.Number(i.width)).height(
            new v.Number(i.height)
          );
        },
        clone: function () {
        ...
        svg: function (t) {
          ...
          i.innerHTML =
            ...
            t.replace(/\n/, "").replace(/<(\w+)([^<]+?)\/>/g, "<$1$2></$1>") +
            "</svg>";
          for (var n = 0, r = i.firstChild.childNodes.length; r > n; n++)
    ...
    (v.morph = function (t, e) {
      return new MorphObj(t, e).at(pos);
    }),
    (v.Situation = v.invent({
      create: function (t) {
        (this.init = !1),
          (this.reversed = !1),
          (this.reversing = !1),
          (this.duration = new v.Number(t.duration).valueOf()),
          (this.delay = new v.Number(t.delay).valueOf()),
    ...
    (v.FX = v.invent({
      ...
      extend: {
        ...
        target: function (t) {
          return t && t instanceof v.Element
            ? ((this._target = t), this)
            : this._target;
        },
          ...
          return (
            !this.active &&
              ...
              (this.situation.finish =
                this.situation.start + this.situation.duration),
              this.initAnimations(),
              (this.active = !0),
              this.startAnimFrame()),
            this
        ...
        queue: function (t) {
          return (
            ("function" == typeof t ||
              t instanceof v.Situation ||
              t instanceof v.Delay) &&
        ...
        dequeue: function () {
          if (
            ...
            var t = function () {
              this.situation instanceof v.Situation
                ? this.initAnimations().at(0)
                : this.situation instanceof v.Delay
                ? this.dequeue()
        ...
        initAnimations: function () {
          ...
          for (t in e.animations)
            "viewbox" == t
              ? (e.animations[t] = this.target()
                  .viewbox()
                  .morph(e.animations[t]))
              : ((e.animations[t].value =
                  "plot" == t
                    ? this.target().array().value
                    : this.target()[t]()),
                e.animations[t].value.value &&
                  (e.animations[t].value = e.animations[t].value.value),
                e.animations[t].relative &&
                  (e.animations[t].destination.value =
                    e.animations[t].destination.value + e.animations[t].value));
          for (t in e.attrs)
            if (e.attrs[t] instanceof v.Color) {
        ...
        at: function (t) {
          return (
            (this.pos = t),
            (this.situation.start = +new Date() - t * this.situation.duration),
            (this.situation.finish =
              this.situation.start + this.situation.duration),
            this.step(!0)
          );
        ...
        speed: function (t) {
          return (
            (this.situation.duration =
              this.situation.duration * this.pos +
              ((1 - this.pos) * this.situation.duration) / t),
            (this.situation.finish =
              this.situation.start + this.situation.duration),
            this.at(this.pos)
          );
        ...
        loop: function (t, e) {
          return (
            (this.situation.loop = this.situation.loops = t || !0),
            e && (this.last().reversing = !0),
            this
          );
        },
        pause: function () {
        ...
        during: function (t) {
          var e = this.last(),
            i = function (i) {
              i.detail.situation == e &&
                t.call(this, i.detail.pos, v.morph, i.detail.eased, e);
            };
          return (
        ...
        afterAll: function (t) {
          ...
          return (
            this.target().off("allfinished.fx", e).on("allfinished.fx", e), this
          );
        },
        ...
        step: function (t) {
          if (
            (t || (this.pos = this.timeToPos(+new Date())),
            this.pos >= 1 &&
              (this.situation.loop === !0 ||
                ("number" == typeof this.situation.loop &&
                  --this.situation.loop)))
          )
            return (
              this.situation.reversing &&
          ...
          for (var i in this.situation.once)
            i > this.lastPos &&
              e >= i &&
              (this.situation.once[i].call(this.target(), this.pos, e),
        ...
        eachAt: function () {
          ...
          for (t in r.animations)
            (e = [].concat(r.animations[t]).map(function (t) {
              return t.at ? t.at(r.ease(i.pos), i.pos) : t;
            })),
              n[t].apply(n, e);
          for (t in r.attrs)
            (e = [t].concat(r.attrs[t]).map(function (t) {
              return t.at ? t.at(r.ease(i.pos), i.pos) : t;
            })),
              n.attr.apply(n, e);
          for (t in r.styles)
            (e = [t].concat(r.styles[t]).map(function (t) {
              return t.at ? t.at(r.ease(i.pos), i.pos) : t;
            })),
              n.style.apply(n, e);
          if (r.transforms.length) {
            ...
            for (t in r.transforms) {
              ...
              s instanceof v.Matrix
                ? (e = s.relative
                    ? e.multiply(s.at(r.ease(this.pos)))
                    : e.morph(s).at(r.ease(this.pos)))
                : (s.relative || s.undo(e.extract()),
                  (e = e.multiply(s.at(r.ease(this.pos)))));
            }
            n.matrix(e);
          }
          return this;
        ...
        once: function (t, e, i) {
          return (
            i || (t = this.situation.ease(t)),
            (this.situation.once[t] = e),
            this
          );
        },
      },
    ...
    (v.MorphObj = v.invent({
      create: function (t, e) {
        return v.Color.isColor(e)
          ? new v.Color(t).morph(e)
          : v.regex.numberAndUnit.test(e)
          ? new v.Number(t).morph(e)
          : ((this.value = 0), (this.destination = e), void 0);
      },
      extend: {
        at: function (t, e) {
    ...
    v.extend(v.FX, {
      attr: function (t, e) {
        if ("object" == typeof t) for (var i in t) this.attr(i, t[i]);
        else this.add(t, new v.MorphObj(null, e), "attrs");
        return this;
      },
      style: function (t, e) {
        if ("object" == typeof t) for (var i in t) this.style(i, t[i]);
        else this.add(t, new v.MorphObj(null, e), "styles");
        return this;
      },
      x: function (t, e) {
        if (this.target() instanceof v.G)
      ...
      size: function (t, e) {
        if (this.target() instanceof v.Text) this.attr("font-size", t);
        else {
          var i;
          (t && e) || (i = this.target().bbox()),
            t || (t = (i.width / i.height) * e),
            e || (e = (i.height / i.width) * t),
            this.add("width", new v.Number().morph(t)).add(
              "height",
              new v.Number().morph(e)
            );
        }
        return this;
      },
      ...
      leading: function (t) {
        return this.target().leading
          ? this.add("leading", new v.Number().morph(t))
          : this;
      },
      viewbox: function (t, e, i, n) {
        return (
          this.target() instanceof v.Container &&
            this.add("viewbox", new v.ViewBox(t, e, i, n)),
          this
        );
      },
      update: function (t) {
        if (this.target() instanceof v.Stop) {
          if ("number" == typeof t || t instanceof v.Number)
            return this.update({
              offset: arguments[0],
              color: arguments[1],
              opacity: arguments[2],
        ...
        if (t) {
          ...
          try {
            ...
            if (t instanceof v.Shape) {
              var n = t.clone().addTo(v.parser.draw);
              (e = n.bbox()), n.remove();
            } else
              e = {
                x: t.node.clientLeft,
      ...
      create: function (e) {
        if (e) {
          ...
          for (
            ...
            (this.x -= i.offsetLeft), (this.y -= i.offsetTop);
          for (i = e; i.parent && (i = i.parent()); )
            i.viewbox &&
              ((r *= i.viewbox().zoom),
              (this.x -= i.x() || 0),
              (this.y -= i.y() || 0));
    ...
    (v.Matrix = v.invent({
      create: function (t) {
        ...
        for (
          ...
          this[w[e]] = t && "number" == typeof t[w[e]] ? t[w[e]] : i[w[e]];
      },
      extend: {
        extract: function () {
          var t = u(this, 0, 1),
        ...
        at: function (t) {
          ...
          if (this.param && this.param.to) {
            var i = {
              rotation:
                this.param.from.rotation +
                (this.param.to.rotation - this.param.from.rotation) * t,
              cx: this.param.from.cx,
              cy: this.param.from.cy,
            };
            (e = e.rotate(
              (this.param.to.rotation - 2 * this.param.from.rotation) * t,
              i.cx,
              i.cy
            )),
              (e.param = i);
        ...
        scale: function (t, e, i, n) {
          return (
            (1 == arguments.length || 3 == arguments.length) && (e = t),
            3 == arguments.length && ((n = i), (i = e)),
            this.around(i, n, new v.Matrix(t, 0, 0, e, 0, 0))
          );
        },
        ...
        around: function (t, e, i) {
          return this.multiply(new v.Matrix(1, 0, 0, 1, t || 0, e || 0))
            .multiply(i)
            .multiply(new v.Matrix(1, 0, 0, 1, -t || 0, -e || 0));
        },
        native: function () {
          for (
            var t = v.parser.draw.node.createSVGMatrix(), e = w.length - 1;
            e >= 0;
            e--
          )
            t[w[e]] = this[w[e]];
    ...
    (v.Point = v.invent({
      ...
      extend: {
        ...
        native: function () {
          var t = v.parser.draw.node.createSVGPoint();
      ...
      attr: function (t, e, i) {
        if (null == t) {
          for (t = {}, e = this.node.attributes, i = e.length - 1; i >= 0; i--)
            t[e[i].nodeName] = v.regex.isNumber.test(e[i].nodeValue)
        ...
        if ("object" == typeof t) for (e in t) this.attr(e, t[e]);
          ...
          "stroke-width" == t
            ...
            ("fill" == t || "stroke" == t) &&
              (v.regex.isImage.test(e) &&
                (e = this.doc().defs().image(e, 0, 0)),
              e instanceof v.Image &&
                (e = this.doc()
                  .defs()
            ...
            "number" == typeof e
              ...
              : Array.isArray(e)
              ? (e = new v.Array(e))
              : e instanceof v.Matrix && e.param && (this.param = e.param),
            "leading" == t
    ...
    v.extend(v.Element, {
      transform: function (t, e) {
        ...
        if ("object" != typeof t)
          return (
            (i = new v.Matrix(n).extract()), "string" == typeof t ? i[t] : i
          );
        if (((i = new v.Matrix(n)), (e = !!e || !!t.relative), null != t.a))
          i = e ? i.multiply(new v.Matrix(t)) : new v.Matrix(t);
          ...
          if (
            ...
            var r = i.extract();
            i = i.multiply(
              new v.Matrix().skew(r.skewX, r.skewY, t.cx, t.cy).inverse()
            );
          }
          ...
          t.flip
            ? (i = i.flip(
                t.flip,
                null == t.offset ? n.bbox()["c" + t.flip] : t.offset
              ))
            : (null != t.x || null != t.y) &&
              (e
        ...
        return "object" != typeof t
          ...
          : ((e = !!e || !!t.relative),
            null != t.a
              ? (i = new v.Matrix(t))
              : null != t.rotation
              ? (f(t, n), (i = new v.Rotate(t.rotation, t.cx, t.cy)))
              ...
              ? (f(t, n),
                ...
                (t.scaleY =
                  null != t.scale ? t.scale : null != t.scaleY ? t.scaleY : 1),
                (i = new v.Scale(t.scaleX, t.scaleY, t.cx, t.cy)))
              : null != t.skewX || null != t.skewY
              ? (f(t, n),
                (t.skewX = null != t.skewX ? t.skewX : 0),
                (t.skewY = null != t.skewY ? t.skewY : 0),
                (i = new v.Skew(t.skewX, t.skewY, t.cx, t.cy)))
              : t.flip
              ? (i = new v.Matrix().morph(
                  new v.Matrix().flip(
                    t.flip,
                    null == t.offset ? n.bbox()["c" + t.flip] : t.offset
                  )
                ))
              : (null != t.x || null != t.y) && (i = new v.Translate(t.x, t.y)),
            i
              ? ((i.relative = e),
    ...
    v.extend(v.Element, {
      ...
      matrixify: function () {
        var t = (this.attr("transform") || "")
          ...
          .map(function (t) {
            ...
            return [
              e[0],
              e[1].split(v.regex.matrixElements).map(function (t) {
                return parseFloat(t);
              }),
            ];
          })
      ...
      toParent: function (t) {
        ...
        var e = this.screenCTM(),
          i = t.rect(1, 1),
          n = i.screenCTM().inverse();
        return (
          i.remove(), this.addTo(t).untransform().transform(n.multiply(e)), this
        );
      },
      toDoc: function () {
    ...
    (v.Transformation = v.invent({
      create: function (t, e) {
        ...
        if ("object" == typeof t)
          for (var i = 0, n = this.arguments.length; n > i; ++i)
      ...
      extend: {
        at: function (t) {
          for (var e = [], i = 0, n = this.arguments.length; n > i; ++i)
            e.push(this[this.arguments[i]]);
          var r = this._undo || new v.Matrix();
          return (
            (r = new v.Matrix()
              .morph(v.Matrix.prototype[this.method].apply(r, e))
              .at(t)),
        ...
        if (arguments.length < 2)
          if ("object" == typeof t) for (e in t) this.style(e, t[e]);
            ...
            for (var i = 0; i < t.length; i++)
              (e = t[i].split(":")), this.style(e[0].replace(/\s+/g, ""), e[1]);
          }
        else
          this.node.style[r(t)] =
            null === e || v.regex.isBlank.test(e) ? "" : e;
        return this;
      },
    }),
    (v.Parent = v.invent({
      ...
      extend: {
        children: function () {
          return v.utils.map(
            v.utils.filterSVGElements(this.node.childNodes),
            function (t) {
              return v.adopt(t);
            }
          );
        ...
        add: function (t, e) {
          return (
            this.has(t) ||
              ((e = null == e ? this.children().length : e),
        ...
        each: function (t, e) {
          ...
          for (i = 0, n = r.length; n > i; i++)
            r[i] instanceof v.Element && t.apply(r[i], [i, r]),
              e && r[i] instanceof v.Container && r[i].each(t, e);
          return this;
        },
    ...
    v.extend(v.Parent, {
      ungroup: function (t, e) {
        return 0 === e || this instanceof v.Defs
          ? this
          : ((t = t || (this instanceof v.Doc ? this : this.parent(v.Parent))),
            (e = e || 1 / 0),
            this.each(function () {
              return this instanceof v.Defs
                ? this
                : this instanceof v.Parent
                ? this.ungroup(t, e - 1)
                : this.toParent(t);
            }),
    ...
    (v.on = function (t, e, i, n) {
      var r = i.bind(n || t.instance || t),
        s = (v.handlerMap.indexOf(t) + 1 || v.handlerMap.push(t)) - 1,
        a = e.split(".")[0],
        o = e.split(".")[1] || "*";
      (v.listeners[s] = v.listeners[s] || {}),
        (v.listeners[s][a] = v.listeners[s][a] || {}),
        (v.listeners[s][a][o] = v.listeners[s][a][o] || {}),
        i._svgjsListenerId || (i._svgjsListenerId = ++v.listenerId),
        (v.listeners[s][a][o][i._svgjsListenerId] = r),
        t.addEventListener(a, r, !1);
    }),
    (v.off = function (t, e, i) {
      var n = v.handlerMap.indexOf(t),
        r = e && e.split(".")[0],
        s = e && e.split(".")[1];
      if (-1 != n)
        if (i) {
          ...
          v.listeners[n][r] &&
            v.listeners[n][r][s || "*"] &&
            (t.removeEventListener(r, v.listeners[n][r][s || "*"][i], !1),
            delete v.listeners[n][r][s || "*"][i]);
        } else if (s && r) {
          ...
          for (e in v.listeners[n])
            for (namespace in v.listeners[n][e])
              s === namespace && v.off(t, [e, s].join("."));
        else if (r) {
          if (v.listeners[n][r]) {
            for (namespace in v.listeners[n][r])
              v.off(t, [r, namespace].join("."));
      ...
      fire: function (t, e) {
        return (
          t instanceof Event
            ...
            : this.node.dispatchEvent(new b(t, { detail: e })),
          this
        );
      },
    }),
    (v.Defs = v.invent({ create: "defs", inherit: v.Container })),
    (v.G = v.invent({
      create: "g",
      inherit: v.Container,
      extend: {
    ...
    v.extend(v.Element, {
      ...
      forward: function () {
        ...
        return (
          ...
          e instanceof v.Doc && e.node.appendChild(e.defs().node),
          this
        );
      },
      backward: function () {
      ...
      front: function () {
        ...
        return (
          ...
          t instanceof v.Doc && t.node.appendChild(t.defs().node),
          this
        );
      },
      back: function () {
    ...
    v.extend(v.Element, {
      maskWith: function (t) {
        return (
          (this.masker = t instanceof v.Mask ? t : this.parent().mask().add(t)),
    ...
    v.extend(v.Element, {
      clipWith: function (t) {
        return (
          (this.clipper =
            t instanceof v.ClipPath ? t : this.parent().clip().add(t)),
      ...
      extend: {
        ...
        attr: function (t, e, i) {
          return (
            ...
            v.Container.prototype.attr.call(this, t, e, i)
          );
        },
      },
      construct: {
    ...
    v.extend(v.Gradient, v.FX, {
      from: function (t, e) {
        return "radial" == (this.target || this).type
          ? this.attr({ fx: new v.Number(t), fy: new v.Number(e) })
          : this.attr({ x1: new v.Number(t), y1: new v.Number(e) });
      },
      to: function (t, e) {
        return "radial" == (this.target || this).type
          ? this.attr({ cx: new v.Number(t), cy: new v.Number(e) })
    ...
    (v.Stop = v.invent({
      ...
      extend: {
        update: function (t) {
          return (
            ("number" == typeof t || t instanceof v.Number) &&
              (t = {
                offset: arguments[0],
                color: arguments[1],
                opacity: arguments[2],
            ...
            null != t.opacity && this.attr("stop-opacity", t.opacity),
            null != t.color && this.attr("stop-color", t.color),
            null != t.offset && this.attr("offset", new v.Number(t.offset)),
            this
          );
        },
      },
    ...
    (v.Doc = v.invent({
      create: function (t) {
        t &&
          ...
          "svg" == t.nodeName
            ? this.constructor.call(this, t)
            : (this.constructor.call(this, v.create("svg")),
      ...
      extend: {
        namespace: function () {
          return this.attr({ xmlns: v.ns, version: "1.1" })
            .attr("xmlns:xlink", v.xlink, v.xmlns)
            .attr("xmlns:svgjs", v.svgjs, v.xmlns);
        },
        defs: function () {
          if (!this._defs) {
            var t;
        ...
        parent: function () {
          return "#document" == this.node.parentNode.nodeName
            ? null
    ...
    (v.Bare = v.invent({
      create: function (t, e) {
        if ((this.constructor.call(this, v.create(t)), e))
    ...
    (v.Circle = v.invent({
      ...
      construct: {
        circle: function (t) {
          return this.put(new v.Circle())
            .rx(new v.Number(t).divide(2))
            .move(0, 0);
        },
      },
    })),
    ...
    v.extend(v.Circle, v.Ellipse, {
      ...
      size: function (t, e) {
        var i = h(this.bbox(), t, e);
        return this.rx(new v.Number(i.width).divide(2)).ry(
          new v.Number(i.height).divide(2)
        );
      },
    }),
    (v.Line = v.invent({
    ...
    v.extend(v.Polyline, v.Polygon, {
      array: function () {
        return (
          this._array || (this._array = new v.PointArray(this.attr("points")))
        );
      },
      plot: function (t) {
    ...
    (v.Text = v.invent({
      create: function () {
        this.constructor.call(this, v.create("text")),
          (this.dom.leading = new v.Number(1.3)),
          (this._rebuild = !0),
          (this._build = !1),
          this.attr("font-family", v.defaults.attrs["font-family"]);
      },
      inherit: v.Shape,
      extend: {
        clone: function () {
        ...
        y: function (t) {
          ...
          return null == t
            ? "number" == typeof e
              ? e - i
              : e
            : this.attr("y", "number" == typeof t ? t + i : t);
        },
        cx: function (t) {
        ...
        leading: function (t) {
          return null == t
            ? this.dom.leading
            : ((this.dom.leading = new v.Number(t)), this.rebuild());
        },
        lines: function () {
          var t = ((this.textPath && this.textPath()) || this).node,
            e = v.utils.map(
              v.utils.filterSVGElements(t.childNodes),
              function (t) {
                return v.adopt(t);
              }
            );
        ...
        rebuild: function (t) {
          if (("boolean" == typeof t && (this._rebuild = t), this._rebuild)) {
            var e = this,
              i = 0,
              n = this.dom.leading * new v.Number(this.attr("font-size"));
            this.lines().each(function () {
              this.dom.newLined &&
                (this.textPath || this.attr("x", e.attr("x")),
                "\n" == this.text()
                  ? (i += n)
        ...
        setData: function (t) {
          return (
            (this.dom = t),
            (this.dom.leading = new v.Number(t.leading || 1.3)),
            this
          );
        },
      },
    ...
    v.extend(v.Text, v.Tspan, {
      ...
      tspan: function (t) {
        var e = ((this.textPath && this.textPath()) || this).node,
          i = new v.Tspan();
        return (
          this._build === !1 && this.clear(), e.appendChild(i.node), i.text(t)
        );
      },
      clear: function () {
        for (
    ...
    (v.TextPath = v.invent({
      ...
      construct: {
        path: function (t) {
          for (
            var e = new v.TextPath(), i = this.doc().defs().path(t);
    ...
    v.extend(v.Line, v.Polyline, v.Polygon, v.Path, {
      marker: function (t, e, i, n) {
        ...
        return (
          ...
          (r = r.join("-")),
          (t =
            arguments[1] instanceof v.Marker
              ? arguments[1]
  ...
  ["fill", "stroke"].forEach(function (t) {
    ...
    (i[t] = function (i) {
      if (
        ...
        for (e = y[t].length - 1; e >= 0; e--)
          null != i[y[t][e]] && this.attr(y.prefix(t, y[t][e]), i[y[t][e]]);
      return this;
    }),
    ...
    v.extend(v.Rect, v.Ellipse, v.Circle, v.Gradient, v.FX, {
      radius: function (t, e) {
        var i = (this.target || this).type;
        return "radial" == i || "circle" == i
          ? this.attr({ r: new v.Number(t) })
    ...
    (v.Set.inherit = function () {
      var t,
        e = [];
      for (var t in v.Shape.prototype)
        "function" == typeof v.Shape.prototype[t] &&
          "function" != typeof v.Set.prototype[t] &&
          e.push(t);
      e.forEach(function (t) {
        v.Set.prototype[t] = function () {
          ...
          return "animate" == t
            ? this.fx || (this.fx = new v.FX.Set(this))
            : this;
        };
      }),
        (e = []);
      for (var t in v.FX.prototype)
        "function" == typeof v.FX.prototype[t] &&
          "function" != typeof v.FX.Set.prototype[t] &&
          e.push(t);
      e.forEach(function (t) {
      ...
      data: function (t, e, i) {
        if ("object" == typeof t) for (e in t) this.data(e, t[e]);
          ...
          this.attr(
            ...
            null === e
              ? null
              : i === !0 || "string" == typeof e || "number" == typeof e
              ? e
              : JSON.stringify(e)
          );
        return this;
    ...
    (v.select = function (t, i) {
      return new v.Set(
        v.utils.map((i || e).querySelectorAll(t), function (t) {
          return v.adopt(t);
        })
      );
    }),
